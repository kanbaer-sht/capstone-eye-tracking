...
class VideoTransformTrack(MediaStreamTrack):
    ...
    async def recv(self):
        ...
        test = np.full(size, new_frame, np.uint8)  # ndarray to image data for openCV
        ...
        if gaze.is_right():
            ...
            text = "Looking Center"
        print(text)
        cv2.putText(test, text, (90, 60), cv2.FONT_HERSHEY_DUPLEX, 1.6, (147, 58, 31), 2)
        ...
        if True:
            ...
            for facebox in faceboxes:
                ...
                # x축
                cv2.putText(test, str(ang1), tuple(p1), font, 2, (128, 255, 255), 3)
                # y축
                cv2.putText(test, str(ang2), tuple(x1), font, 2, (255, 255, 128), 3)
